...
movie = pd.read_csv(
    hf_hub_download(
        "yashasvi-01-02/movie-recommendation",
...
def recommend_movies(query: str, top_n: int = 10):
    ...
    similarity = cosine_similarity(
        query_vec_reduced,
        vector_reduced[movies_filtered.index.to_numpy()]
    ).flatten()

    top_indices = similarity.argsort()[::-1][2:top_n + 1]

    recommended = movies_filtered.iloc[top_indices][[
        'id',
        'imdb_id',
        'title',
        'vote_average',
